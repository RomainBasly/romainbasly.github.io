...
date: "2024-11-29"
description: "The Scrum methodology seems to have taken the world by storm. This framework is now the standard in the tech industry and is expanding daily into new sectors of the economy. The question we aim to address in this series of articles is: What exactly is it? How is it different? And why should you consider adopting it for your own projects? (More ...)"
author: "Romain Basly"
image:
...
<div>
The Scrum methodology seems to have taken the world by storm. This framework is now the standard in the tech industry and is expanding daily into new sectors of the economy. The question we aim to address in this series of articles is: What exactly is it? How is it different? And why should you consider adopting it for your own projects?

After working within a development team that followed the Scrum methodology, I decided to return to its roots by diving into the compelling book *The Art of Doing Twice the Work in Half the Time* by Jeff Sutherland—the founder of the methodology. My goal here is to understand the origins of this framework, what makes it so unique, what it achieves, and to analyze the assumptions it entails. I also wanted to compare the corporate experience I had with the principles laid out by its author.

While documenting what Scrum is, I found that its broad outlines are widely recognized among professionals. However, the underlying assumptions that make this framework truly effective are less well understood. This series of articles seeks to explore these ideas and bring them to light. 
</div>
<div>
