---
title: "Scrum Framework - The origins"
lang: "en"
translation: "/posts/fr/3"
date: "2024-11-29"
description: "The world appears to have developed a fascination for the Scrum framework. It is now the standard in the tech industry and is expanding daily into new sectors of the economy. The question we aim to address in this series of articles is: What exactly is it? How is it different? Why should you consider adopting it for your own projects? And more importantly, when is it likely less appropriate for your type of activity ?(More ...)"
author: "Romain Basly"
image:
...
<div>
The Scrum Framework  seems to have taken the world by storm. It is now the standard in the tech industry and is expanding daily into new sectors of the economy. The question we aim to address in this series of articles is: What exactly is it? How is it different? Why should you consider adopting it for your own projects? And more importantly, when is it **likely not appropriate** for your type of activity?
</div>
<div>
After working within a development team that followed the Scrum guidelines, I decided to return to its roots by diving into the compelling book *The Art of Doing Twice the Work in Half the Time* by Jeff Sutherland — the founder of the Framework. My goal here is to understand the origins of this framework, what makes it so unique, what it achieves, and to analyze the assumptions it entails. I also wanted to compare the corporate experience I had with the principles laid out by its author.
</div>
<div>
While documenting what Scrum is, I found that its broad outlines are widely recognized among professionals. However, the underlying assumptions that make this framework truly effective are less well understood. This series of articles seeks to explore these ideas, bring them to light and explore potential limits of the Framework. 
</div>
<div>
But first, the primary question: What kind of problems is Scrum designed to solve?
</div>

## The origin - from one failure to another : the case of the FBI
<div>
To show the power of Scrum Framework, Jeff Sutherland start his book by emphasizing the story of the FBI and its modernization of its Information System: 
> **"<span style="color: tomato">Before 9/11</span>** (...) “<span style="color: tomato">The FBI’s information systems were woefully inadequate </span>” (...) ”When senators started asking the Bureau some uncomfortable questions (Post 911), the FBI basically said, “Don’t worry, we have a modernization plan already in the works.” The plan was called the Virtual Case File (VCF) system, and it was supposed to change everything. (...) officials said they only needed another $70 million on top of the $100 million already budgeted for the plan (...) <span style="color: tomato">Three years later, the program was killed. </span> It didn’t work. Not even a little bit. The FBI had <span style="color: tomato">spent $170 million in taxpayer money to buy a computer system </span> that would <span style="color: tomato">never be used — not a single line of code</span>, or application, or mouse click. <span style="color: tomato">The whole thing was an unmitigated disaster</span>"

> "**<span style="color: tomato">In 2005</span>** the FBI announced a new program, Sentinel. <span style="color: tomato">This time it would work. This time they’d put in the right safeguards, the right budget procedures, the right controls</span>. They’d learned their lesson. <span style="color: tomato">The price tag? A mere $451 million. And it would be fully operational by 2009 </span>. What could possibly go wrong? **<span style="color: tomato">In March of 2010</span>** the answer landed on Jeff Johnson’s desk. Lockheed Martin, the contractor hired to make the Sentinel system, had already spent $405 million. They’d developed only half of the project, and <span style="color: tomato">it was already a year late</span>. An independent analysis estimated it would take another <span style="color: tomato">six to eight years to finish the project</span>, and the taxpayers would have to throw in at least another $350 million."
...
- **The client changes their mind** between one of these steps - all the steps need to be revisited. In return, it generates more costs in the end because of contractual clauses that enhance the price of the contract at each change. In short, this way of viewing the workflow does not **adapt easily to change**; every subsequent adjustment incurs **additional costs**, which can become highly problematic for a company.
...
<div>
In 2010 a decision was made at the FBI: over budget, behind schedule, and unable to deliver the promised product, they finally turned to Scrum Framework to finish the project. With this new Framework...
...
<div>
Scrum Framework is part of a broader movement known as Agile methodologies (see their manifesto **<a href="https://agilemanifesto.org/principles.html" target="_blank" rel="noopener noreferrer">here</a>**). This collection of methodologies was developed to address the challenges inherent in (and sometimes the failures of) software development, particularly in complex projects. 
Simply put, Scrum is a framework that works in **short cycles**, in which the team **inspects**, **reflects** and adapts **regularly** the workflow **to achieve higher efficiency**.

</div>
Ok, now how does it work concretly? In our **<a href="https://romainbasly.github.io/posts/en/4" rel="noopener noreferrer">next</a>** article, we will enter with a little more depth into the subject.
